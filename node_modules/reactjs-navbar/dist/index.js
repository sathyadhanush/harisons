...
var Navbar = /*#__PURE__*/function (_Component) {
    ...
    markup = subSubItems.map(function (subSubItem) {
      if (!_this2.shouldRender(subSubItem.isAuth)) {
        ...
        React__default.createElement("a", {
          key: uuid(),
          href: "#"
        }, subSubItem.title), subSubItem.subItems ? /*#__PURE__*/React__default.createElement("span", {
          key: uuid(),
          className: style.chevron + " " + style.chevronRight
        }) : null, subSubItem.subItems ? /*#__PURE__*/React__default.createElement("div", {
          key: uuid(),
          className: style.subSubMenu
        }, /*#__PURE__*/React__default.createElement("ul", null, " ", _this2.buildSubSubMenu(subSubItem.subItems), " ")) : null].map(function (e) {
          return e;
        }));
      }
    });
  ...
  _proto.buildMenu = function buildMenu(_ref) {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
    ...
    }, /*#__PURE__*/React__default.createElement("ul", null, menuItems.map(function (rootItem) {
      if (!_this3.shouldRender(rootItem.isAuth)) {
        ...
        React__default.createElement("a", {
          href: "#",
          key: uuid()
        }, rootItem.title), rootItem.subItems ? /*#__PURE__*/React__default.createElement("span", {
          key: uuid(),
          className: style.chevron + " " + style.chevronBottom
        }) : null, rootItem.subItems ? /*#__PURE__*/React__default.createElement("div", {
          key: uuid(),
          className: style.subMenu
        }, /*#__PURE__*/React__default.createElement("ul", null, rootItem.subItems.map(function (subItem) {
          if (!_this3.shouldRender(subItem.isAuth)) {
            ...
            React__default.createElement("a", {
              key: uuid(),
              href: "#"
            }, subItem.title), subItem.subItems ? /*#__PURE__*/React__default.createElement("span", {
              key: uuid(),
              className: style.chevron + " " + style.chevronRight
            }) : null, subItem.subItems ? /*#__PURE__*/React__default.createElement("div", {
              key: uuid(),
              className: style.subSubMenu
            }, /*#__PURE__*/React__default.createElement("ul", null, _this3.buildSubSubMenu(subItem.subItems))) : null].map(function (e) {
              return e;
            }));
          }
        }))) : null].map(function (e) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
    ...
    }, this.props.logo && /*#__PURE__*/React__default.createElement("div", {
    ...
    }, this.props.loader ? this.props.loader : /*#__PURE__*/React__default.createElement("div", {
      className: style.loader,
      style: {
        opacity: this.props.isLoading ? "1" : "0"
      }
    }))), this.buildMenu(this.props), this.props.helpCallback && /*#__PURE__*/React__default.createElement("div", {
      ...
      href: "#"
    }, "Help"), /*#__PURE__*/React__default.createElement(reactFontawesome.FontAwesomeIcon, {
